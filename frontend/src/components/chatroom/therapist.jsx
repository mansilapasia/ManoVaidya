...
export default function TherapistChatroom(props) {
        ...
        return (
            sessions.sessions.sessions.map((session) => (
                <Grid container item xs={16} spacing={3}>
                    <React.Fragment>
                        <Grid item xs={5}>
                            <Paper className={classes.paper}>User Anonyous Name: {randomName()}</Paper>
                        </Grid>
                        <Grid item xs={2}>
    ...
    return (
        <div>
            ...
            <Grid container spacing={3}>
                <Grid item xs={4} className={classes.appointment}>
                    <Paper className={classes.paper}>Appointments</Paper>
                </Grid>
                <Grid item xs className={classes.appointment}>
